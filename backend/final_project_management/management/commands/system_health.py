...
# Profile model doesn't exist - using User model directly
...
from settings.models import SystemSettings, SystemLog
    ...
    def check_system_settings(self):
        ...
        try:
            ...
            for setting_key in required_settings:
                if not SystemSettings.objects.filter(key=setting_key).exists():
